...
@ConfigGroup(value = "spoonnightmare")
public interface SpoonNightmareConfig extends Config
{
	...
	String nightmareSection = "nightmare";
	...
	@ConfigItem(keyName = "parasiteTimer", name = "Parasite Spawn Timer", description = "Notifies you when a parasite has attached to you, and shows the spawn timer for it.", section = "nightmare")
	...
	default hideAttackMode hideAttack()
	{
		return hideAttackMode.OFF;
	}
	...
	default hideAttackIgnoreMode hideAttackIgnore()
	{
		return hideAttackIgnoreMode.OFF;
	}
	...
	default totemColorMode totemColorMode()
	{
		return totemColorMode.COLOR;
	}
	...
	default boolean eventTickCounter()
	{
		return false;
	}
	...
	default Color tickCounterColor()
	{
		return Color.WHITE;
	}
	...
	default boolean matchStyleColor()
	{
		return false;
	}
	...
	default boolean displayStatsMsg()
	{
		return false;
	}
	...
	default boolean sleepwalkerStats()
	{
		return false;
	}
	...
	default healingStatsMode healingStats()
	{
		return healingStatsMode.OFF;
	}
