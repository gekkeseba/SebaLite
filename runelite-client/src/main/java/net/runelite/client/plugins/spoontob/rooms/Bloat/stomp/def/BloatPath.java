	...
	N_PATH
		{
			public List<Pair<SSLine[], int[]>> getCornerSafespots(SSLine[][][] bloatGrid)
			{
				return Arrays.asList(
					new ImmutablePair<>(IPath.getSECornerLines(bloatGrid), SE_OFFSETS),
					new ImmutablePair<>(IPath.getSWCornerLines(bloatGrid), SW_OFFSETS));
			}
	...
	E_PATH
		{
			public List<Pair<SSLine[], int[]>> getCornerSafespots(SSLine[][][] bloatGrid)
			{
				return Arrays.asList(
					new ImmutablePair<>(IPath.getSWCornerLines(bloatGrid), SW_OFFSETS),
					new ImmutablePair<>(IPath.getNWCornerLines(bloatGrid), NW_OFFSETS));
			}
	...
	S_PATH
		{
			public List<Pair<SSLine[], int[]>> getCornerSafespots(SSLine[][][] bloatGrid)
			{
				return Arrays.asList(
					new ImmutablePair<>(IPath.getNWCornerLines(bloatGrid), NW_OFFSETS),
					new ImmutablePair<>(IPath.getNECornerLines(bloatGrid), NE_OFFSETS));
			}
