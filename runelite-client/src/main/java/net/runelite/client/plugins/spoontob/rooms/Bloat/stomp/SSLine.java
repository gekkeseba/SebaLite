...
public final class SSLine
{
	...
	{
		return offset(offsetFunc, offsetFunc);
	}
	...
	public SSLine offset(UnaryOperator<Coordinates> offsetFuncA, UnaryOperator<Coordinates> offsetFuncB)
	{
		return new SSLine(
			...
			offsetFuncB == null ? this.coordB : offsetFuncB.apply(this.coordB),
			this.sigX, this.sigY);
	}
	...
	public boolean equals(Object other)
	{
		...
		SSLine o = (SSLine) other;
		return this.coordA.equals(o.coordA) && this.coordB.equals(o.coordB);
	}
