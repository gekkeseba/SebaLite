...
{
	public static final SSLine[][][] grid = new SSLine[][][]{
		{
			{new SSLine(new Coordinates(29, 39), new Coordinates(29, 34), -1, 1), new SSLine(new Coordinates(29, 29), new Coordinates(29, 24), -1, -1)},
			{new SSLine(new Coordinates(34, 39), new Coordinates(34, 34), 1, 1), new SSLine(new Coordinates(34, 29), new Coordinates(34, 24), 1, -1)}
		},
		{
			{new SSLine(new Coordinates(24, 34), new Coordinates(29, 34), -1, 1), new SSLine(new Coordinates(34, 34), new Coordinates(39, 34), 1, 1)},
			{new SSLine(new Coordinates(28, 29), new Coordinates(23, 29), 1, -1), new SSLine(new Coordinates(34, 29), new Coordinates(39, 29), 1, -1)}
		}
	};
	...
	public List<SSLine> getCornerSafespots()
	{
		...
		return Arrays.asList(
			safespotLines[bit].offset(c -> c.dx(isCol ? offsets[0] : offsets[2]).dy(isCol ? offsets[1] : offsets[3])),
	...
	public List<SSLine> getSideSafespots()
	{
		...
		return Arrays.asList(
			safespotLines[0].offset(c -> c.dx(this.bloatPath.shouldOffsetX() ? offsets.get(0) : 0).dy(this.bloatPath.shouldOffsetY() ? offsets.get(0) : 0)),
			safespotLines[1].offset(c -> c.dx(this.bloatPath.shouldOffsetX() ? offsets.get(1) : 0).dy(this.bloatPath.shouldOffsetY() ? offsets.get(1) : 0)));
	}
}
